...
public class GradleStart extends GradleStartCommon
{
    ...
    protected void setDefaultArguments(Map<String, String> argMap)
    {
        ...
        argMap.put("assetsDir",      "C:/maven/apache-maven-3.8.6/caches/minecraft/assets");
    ...
    private static void hackNatives()
    {
        ...
        String nativesDir = "C:/maven/apache-maven-3.8.6/caches/minecraft/net/minecraft/natives/1.12.2";
