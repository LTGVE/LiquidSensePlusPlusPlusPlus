...
class KillAura : Module() {
    ...
    private val rotations = ListValue("RotationMode", arrayOf("None", "New", "Liquidbounce","BackTrack", "Test1", "Test2","KanaeSb"), "New")
...
//        inline get() = mc.thePlayer!!.heldItem != null && classProvider.isItemSword(mc.thePlayer!!.heldItem!!.item)
    ...
    override val tag: String
        get() = targetModeValue.get() +" "+ maxCPS.get()+"CPS" +"-"+minCPS.get()+"CPS"+" "+maxRange.toString() +" "+priorityValue.get()
